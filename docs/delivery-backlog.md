...
| 5 | [UC-005 operational dashboard](../solutions/operations/use-cases/UC-005-operational-dashboard.md): live module inventory, declared connections and authorised content/activity summaries | All implemented families; replaceable client | Implemented for synthetic macOS development; [run/evidence](../solutions/operations/uc005/README.md); nine monitoring acceptance tests |

...
| 3 | [UC-003 source-scoped observations](../solutions/sensor-path/use-cases/UC-003-source-scoped-observations.md): one source/owner/consumer permission covers multiple observations with traceable delivery | Wallet, Connector, client | Next; scope agreed, ready for implementation; no runtime yet |

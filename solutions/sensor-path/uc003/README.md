...
This runs all six slice suites, foundation checks, documentation checks and five model-independent demos. Add `--with-local-model` for the [UC-004 real-model demo](../../assisted-answer/uc004/README.md). Run only this slice's nine acceptance tests with:
